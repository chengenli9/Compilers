...
END_CLASS_Object: # ClassDecl at 0.0
  .byte 66 # StringLit at 10.19
  .byte 117 # StringLit at 10.19
  .byte 100 # StringLit at 10.19
  .byte 100 # StringLit at 10.19
  .byte 121 # StringLit at 10.19
  .byte 0 # StringLit at 10.19
  .byte 0 # StringLit at 10.19
  .byte 0 # StringLit at 10.19
  .word CLASS_String # StringLit at 10.19
  .word 3 # StringLit at 10.19
  .word -5 # StringLit at 10.19
strLit_23: # StringLit at 10.19
  .byte 77 # StringLit at 11.23
  .byte 117 # StringLit at 11.23
  .byte 100 # StringLit at 11.23
  .byte 100 # StringLit at 11.23
  .byte 121 # StringLit at 11.23
  .byte 0 # StringLit at 11.23
  .byte 0 # StringLit at 11.23
  .byte 0 # StringLit at 11.23
  .word CLASS_String # StringLit at 11.23
  .word 3 # StringLit at 11.23
  .word -5 # StringLit at 11.23
strLit_30: # StringLit at 11.23
  .byte 65 # StringLit at 16.10
  .byte 0 # StringLit at 16.10
  .byte 0 # StringLit at 16.10
  .byte 0 # StringLit at 16.10
  .word CLASS_String # StringLit at 16.10
  .word 2 # StringLit at 16.10
  .word -1 # StringLit at 16.10
strLit_40: # StringLit at 16.10
.text
.globl main
main:
  jal vm_init
...
# end: Null at 4.15; stackHeight = 4
  subu $sp, $sp, 4 # LocalVarDecl at 4.8; stackHeight = 4
  sw $t0, ($sp) # LocalVarDecl at 4.8; stackHeight = 4
# begin: Call at 6.19; stackHeight = 8
# begin: IntLit at 6.24; stackHeight = 8
  li $t0, 44
 subu $sp, $sp, 8
 sw $t0, ($sp)
# end: IntLit at 6.24; stackHeight = 16
 ...
 subu $sp, $sp, 4
 sw $t0, ($sp)
# end: Call at 6.19; stackHeight = 16
  subu $sp, $sp, 4 # LocalVarDecl at 6.10; stackHeight = 16
  sw $t0, ($sp) # LocalVarDecl at 6.10; stackHeight = 16
# begin: CallStmt at 7.3; stackHeight = 20
# begin: Call at 7.3; stackHeight = 20
# begin: This at 7.3; stackHeight = 20
 subu $sp, $sp, 4
 sw $s2, ($sp)
# end: This at 7.3; stackHeight = 24
 beq $s2, $zero, nullPtrException
 lw $t0, -12($s2)
 lw $t0, 24($t0)
 jalr $t0 # printStr
 ...
 lw $s2, ($sp)
 addu $sp, $sp, 4
# end: Call at 7.3; stackHeight = 20
 lw $t0, ($sp)
 addu $sp, $sp, 4
# end: CallStmt at 7.3; stackHeight = 16
 addu $sp, $sp, 16
 lw $ra, ($sp)
 addu $sp, $sp, 4
 jr $ra
...
mth_name_Main:
 ...
 sw $ra, ($sp)
 lw $s2, 4($sp)
# begin: StringLit at 10.19; stackHeight = 0
 la $t0, strLit_23
 subu $sp, $sp, 4
 sw $t0, ($sp)
# end: StringLit at 10.19; stackHeight = 4
  subu $sp, $sp, 4 # LocalVarDecl at 10.10; stackHeight = 4
  sw $t0, ($sp) # LocalVarDecl at 10.10; stackHeight = 4
# begin: If at 11.3; stackHeight = 8
# begin: GreaterThan at 11.9; stackHeight = 8
# begin: IntLit at 11.11; stackHeight = 8
  li $t0, 0
 subu $sp, $sp, 8
 sw $t0, ($sp)
# end: IntLit at 11.11; stackHeight = 16
 lw $t2, ($sp)
 addu $sp, $sp, 8
 lw $t1, ($sp)
 addu $sp, $sp, 8
 ...
 subu $sp, $sp, 4
 sw $t0, ($sp)
# end: GreaterThan at 11.9; stackHeight = 4
 lw $t0, ($sp)
 addu $sp, $sp, 4
    beq $t0, $zero, if_else_33
# begin: StringLit at 11.23; stackHeight = 0
 la $t0, strLit_30
 subu $sp, $sp, 4
 sw $t0, ($sp)
# end: StringLit at 11.23; stackHeight = 4
    j if_done_33
  if_else_33:
...
# end: If at 11.3; stackHeight = 4
 ...
 addu $sp, $sp, 4
 jr $ra
.globl mth_name_YourClass
mth_name_YourClass:
 subu $sp, $sp, 4
 sw $ra, ($sp)
 lw $s2, 4($sp)
# begin: Call at 16.14; stackHeight = 0
# begin: StringLit at 16.10; stackHeight = 0
 la $t0, strLit_40
 subu $sp, $sp, 4
 sw $t0, ($sp)
# end: StringLit at 16.10; stackHeight = 4
...
# begin: IntLit at 16.34; stackHeight = 8
  li $t0, 20
 subu $sp, $sp, 8
 sw $t0, ($sp)
# end: IntLit at 16.34; stackHeight = 16
 lw $t1, ($sp)
 addu $sp, $sp, 8
 lw $t0, ($sp)
 addu $sp, $sp, 8
 ...
 subu $sp, $sp, 8
 sw $t0, ($sp)
# end: Minus at 16.33; stackHeight = 8
 jal mth_name_Main
 subu $sp, $sp, 4
 sw $t0, ($sp)
# end: Call at 16.27; stackHeight = 12
 beq $s2, $zero, nullPtrException
 lw $t0, -12($s2)
 lw $t0, 12($t0)
 jalr $t0 # concat
 ...
 subu $sp, $sp, 4
 sw $t0, ($sp)
# end: Call at 16.14; stackHeight = 12
 lw $t0, ($sp)
 addu $sp, $sp, 4
 addu $sp, $sp, 8
 lw $ra, ($sp)
