...
END_CLASS_Object: # ClassDecl at 0.0
  .byte 72 # StringLit at 4.20
  .byte 101 # StringLit at 4.20
  .byte 114 # StringLit at 4.20
  .byte 101 # StringLit at 4.20
  .byte 32 # StringLit at 4.20
  .byte 97 # StringLit at 4.20
  .byte 114 # StringLit at 4.20
  .byte 101 # StringLit at 4.20
  .byte 32 # StringLit at 4.20
  .byte 116 # StringLit at 4.20
  .byte 104 # StringLit at 4.20
  .byte 101 # StringLit at 4.20
  .byte 32 # StringLit at 4.20
  .byte 114 # StringLit at 4.20
  .byte 101 # StringLit at 4.20
  .byte 115 # StringLit at 4.20
  .byte 117 # StringLit at 4.20
  .byte 108 # StringLit at 4.20
  .byte 116 # StringLit at 4.20
  .byte 115 # StringLit at 4.20
  .byte 10 # StringLit at 4.20
  .byte 0 # StringLit at 4.20
  .byte 0 # StringLit at 4.20
  .byte 0 # StringLit at 4.20
  .word CLASS_String # StringLit at 4.20
  .word 7 # StringLit at 4.20
  .word -21 # StringLit at 4.20
strLit_0: # StringLit at 4.20
.text
.globl main
main:
  jal vm_init
...
mth_main_Main:
 ...
 sw $ra, ($sp)
 lw $s2, 4($sp)
# begin: CallStmt at 4.11; stackHeight = 0
# begin: Call at 4.11; stackHeight = 0
# begin: Super at 4.11; stackHeight = 0
 subu $sp, $sp, 4
 sw $s2, ($sp)
# end: Super at 4.11; stackHeight = 4
# begin: StringLit at 4.20; stackHeight = 4
 la $t0, strLit_0
 subu $sp, $sp, 4
 sw $t0, ($sp)
# end: StringLit at 4.20; stackHeight = 8
 jal mth_printStr_Lib
# end: Call at 4.11; stackHeight = 8
 lw $t0, ($sp)
 addu $sp, $sp, 4
# end: CallStmt at 4.11; stackHeight = 4
 addu $sp, $sp, 4
 lw $ra, ($sp)
 addu $sp, $sp, 4
 jr $ra
