...
# begin: Minus at 5.16; stackHeight = 8
# begin: IntLit at 5.14; stackHeight = 8
  li $t0, 23
 subu $sp, $sp, 8
 sw $s5, 4($sp)
 sw $t0, ($sp)
# end: IntLit at 5.14; stackHeight = 16
 lw $t1, ($sp)
 lw $s5, 4($sp)
 addu $sp, $sp, 8
 lw $t0, ($sp)
 ...
 sw $s5, 4($sp)
 sw $t0, ($sp)
# end: Minus at 5.16; stackHeight = 8
# begin: StringLit at 6.15; stackHeight = 8
 la $t0, strLit_syntaxtree.StringLit@5ce65a89
# end: StringLit at 6.15; stackHeight = 8
# begin: Call at 7.17; stackHeight = 8
# begin: Super at 7.17; stackHeight = 8
 subu $sp, $sp, 4
 sw $s2, ($sp)
# end: Super at 7.17; stackHeight = 12
# begin: Plus at 7.28; stackHeight = 12
# begin: IntLit at 7.26; stackHeight = 12
  li $t0, 29
 subu $sp, $sp, 8
 sw $s5, 4($sp)
 sw $t0, ($sp)
# end: IntLit at 7.26; stackHeight = 20
 lw $t1, ($sp)
 lw $s5, 4($sp)
 addu $sp, $sp, 8
 lw $t0, ($sp)
 ...
 sw $s5, 4($sp)
 sw $t0, ($sp)
# end: Plus at 7.28; stackHeight = 12
# begin: Call at 8.17; stackHeight = 12
# begin: Super at 8.17; stackHeight = 12
 subu $sp, $sp, 4
 sw $s2, ($sp)
# end: Super at 8.17; stackHeight = 16
 addu $sp, $sp, 16
 lw $ra, ($sp)
 addu $sp, $sp, 4
 jr $ra
