...
END_CLASS_Object: # ClassDecl at 0.0
  ...
  .byte 98 # StringLit at 7.20
  .byte 99 # StringLit at 7.20
  .byte 0 # StringLit at 7.20
  .word CLASS_String # StringLit at 7.20
  .word 2 # StringLit at 7.20
  .word -3 # StringLit at 7.20
strLit_1: # StringLit at 7.20
  .byte 97 # StringLit at 8.20
  .byte 98 # StringLit at 8.20
  .byte 99 # StringLit at 8.20
  .byte 0 # StringLit at 8.20
  .word CLASS_String # StringLit at 8.20
  .word 2 # StringLit at 8.20
  .word -3 # StringLit at 8.20
strLit_5: # StringLit at 8.20
.text
.globl main
main:
  jal vm_init
