...
strLit_0: # StringLit at 5.21
  .byte 100 # StringLit at 5.28
  .byte 101 # StringLit at 5.28
  .byte 102 # StringLit at 5.28
  .byte 0 # StringLit at 5.28
  .word CLASS_String # StringLit at 5.28
  .word 2 # StringLit at 5.28
  .word -3 # StringLit at 5.28
strLit_1: # StringLit at 5.28
.text
.globl main
main:
  jal vm_init
...
# begin: StringLit at 5.28; stackHeight = 8
 la $t0, strLit_1
 subu $sp, $sp, 4
 sw $t0, ($sp)
# end: StringLit at 5.28; stackHeight = 12
 lw $t2, ($sp)
 addu $sp, $sp, 4
 lw $t1, ($sp)
 addu $sp, $sp, 4
