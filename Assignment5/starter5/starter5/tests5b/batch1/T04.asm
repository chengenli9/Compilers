...
# begin: IntLit at 4.20; stackHeight = 4
  li $t0, 3
 subu $sp, $sp, 8
 sw $t0, ($sp)
# end: IntLit at 4.20; stackHeight = 12
# begin: IntLit at 4.22; stackHeight = 12
  li $t0, 52
 subu $sp, $sp, 8
 sw $t0, ($sp)
# end: IntLit at 4.22; stackHeight = 20
 lw $t1, ($sp)
 addu $sp, $sp, 8
 lw $t0, ($sp)
 addu $sp, $sp, 8
...
# end: Call at 4.11; stackHeight = 12
 lw $t0, ($sp)
 addu $sp, $sp, 4
# end: CallStmt at 4.11; stackHeight = 8
 addu $sp, $sp, 8
 lw $ra, ($sp)
 addu $sp, $sp, 4
 jr $ra
