...
# end: Null at 5.14; stackHeight = 4
  ...
  subu $sp, $sp, 4 # LocalVarDecl at 6.6; stackHeight = 8
  sw $t0, ($sp) # LocalVarDecl at 6.6; stackHeight = 8
# begin: CallStmt at 7.8; stackHeight = 12
# begin: Call at 7.8; stackHeight = 12
# begin: Super at 7.8; stackHeight = 12
 subu $sp, $sp, 4
 sw $s2, ($sp)
# end: Super at 7.8; stackHeight = 16
# begin: StringLit at 7.17; stackHeight = 16
 la $t0, strLit_10
 subu $sp, $sp, 4
 sw $t0, ($sp)
# end: StringLit at 7.17; stackHeight = 20
 jal mth_printStr_Lib
# end: Call at 7.8; stackHeight = 20
 lw $t0, ($sp)
 addu $sp, $sp, 4
# end: CallStmt at 7.8; stackHeight = 16
 addu $sp, $sp, 16
 lw $ra, ($sp)
 addu $sp, $sp, 4
 jr $ra
