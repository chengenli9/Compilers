...
# begin: IntLit at 6.6; stackHeight = 8
  li $t0, 4
 subu $sp, $sp, 8
 sw $t0, ($sp)
# end: IntLit at 6.6; stackHeight = 16
# begin: IntLit at 6.11; stackHeight = 16
  li $t0, 24
 subu $sp, $sp, 8
 sw $t0, ($sp)
# end: IntLit at 6.11; stackHeight = 24
