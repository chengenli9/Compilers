...
mth_main_Main:
 ...
 sw $ra, ($sp)
 lw $s2, 4($sp)
# begin: CallStmt at 3.5; stackHeight = 0
# begin: Call at 3.5; stackHeight = 0
# begin: This at 3.5; stackHeight = 0
 subu $sp, $sp, 4
 sw $s2, ($sp)
# end: This at 3.5; stackHeight = 4
# begin: IntLit at 3.14; stackHeight = 4
  li $t0, 345
 subu $sp, $sp, 8
 sw $t0, ($sp)
# end: IntLit at 3.14; stackHeight = 12
 ...
 lw $s2, ($sp)
 addu $sp, $sp, 4
# end: Call at 3.5; stackHeight = 8
 lw $t0, ($sp)
 addu $sp, $sp, 4
# end: CallStmt at 3.5; stackHeight = 4
 addu $sp, $sp, 4
 lw $ra, ($sp)
 addu $sp, $sp, 4
 jr $ra
