...
END_CLASS_Object: # ClassDecl at 0.0
  .byte 97 # StringLit at 5.21
  .byte 98 # StringLit at 5.21
  .byte 99 # StringLit at 5.21
  .byte 0 # StringLit at 5.21
  .word CLASS_String # StringLit at 5.21
  .word 2 # StringLit at 5.21
  .word -3 # StringLit at 5.21
strLit_0: # StringLit at 5.21
  .byte 100 # StringLit at 5.30
  .byte 101 # StringLit at 5.30
  .byte 102 # StringLit at 5.30
  .byte 0 # StringLit at 5.30
  .word CLASS_String # StringLit at 5.30
  .word 2 # StringLit at 5.30
  .word -3 # StringLit at 5.30
strLit_1: # StringLit at 5.30
.text
.globl main
main:
  jal vm_init
...
# begin: StringLit at 5.21; stackHeight = 4
 la $t0, strLit_0
 subu $sp, $sp, 4
 sw $t0, ($sp)
# end: StringLit at 5.21; stackHeight = 8
# begin: StringLit at 5.30; stackHeight = 8
 la $t0, strLit_1
 subu $sp, $sp, 4
 sw $t0, ($sp)
# end: StringLit at 5.30; stackHeight = 12
 lw $t2, ($sp)
 addu $sp, $sp, 4
 lw $t1, ($sp)
 addu $sp, $sp, 4
