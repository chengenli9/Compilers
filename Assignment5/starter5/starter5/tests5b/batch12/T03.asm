...
# end: Null at 5.14; stackHeight = 4
  subu $sp, $sp, 4 # LocalVarDecl at 5.8; stackHeight = 4
  sw $t0, ($sp) # LocalVarDecl at 5.8; stackHeight = 4
# begin: IntLit at 6.14; stackHeight = 8
  li $t0, 3
 subu $sp, $sp, 8
 sw $t0, ($sp)
# end: IntLit at 6.14; stackHeight = 16
  subu $sp, $sp, 4 # LocalVarDecl at 6.6; stackHeight = 16
  sw $t0, ($sp) # LocalVarDecl at 6.6; stackHeight = 16
# begin: CallStmt at 7.8; stackHeight = 20
# begin: Call at 7.8; stackHeight = 20
# begin: Super at 7.8; stackHeight = 20
 subu $sp, $sp, 4
 sw $s2, ($sp)
# end: Super at 7.8; stackHeight = 24
# begin: StringLit at 7.17; stackHeight = 24
 la $t0, strLit_11
 subu $sp, $sp, 4
 sw $t0, ($sp)
# end: StringLit at 7.17; stackHeight = 28
