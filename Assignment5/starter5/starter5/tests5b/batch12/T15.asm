...
END_CLASS_Object: # ClassDecl at 0.0
  .byte 87 # StringLit at 7.17
  .byte 101 # StringLit at 7.17
  .byte 32 # StringLit at 7.17
  .byte 103 # StringLit at 7.17
  .byte 111 # StringLit at 7.17
  .byte 116 # StringLit at 7.17
  .byte 32 # StringLit at 7.17
  .byte 104 # StringLit at 7.17
  .byte 101 # StringLit at 7.17
  .byte 114 # StringLit at 7.17
  .byte 101 # StringLit at 7.17
  .byte 10 # StringLit at 7.17
  .word CLASS_String # StringLit at 7.17
  .word 4 # StringLit at 7.17
  .word -12 # StringLit at 7.17
strLit_8: # StringLit at 7.17
  .byte 32 # StringLit at 10.17
  .byte 46 # StringLit at 10.17
  .byte 46 # StringLit at 10.17
  .byte 46 # StringLit at 10.17
  .byte 32 # StringLit at 10.17
  .byte 115 # StringLit at 10.17
  .byte 104 # StringLit at 10.17
  .byte 111 # StringLit at 10.17
  .byte 117 # StringLit at 10.17
  .byte 108 # StringLit at 10.17
  .byte 100 # StringLit at 10.17
  .byte 32 # StringLit at 10.17
  .byte 110 # StringLit at 10.17
  .byte 111 # StringLit at 10.17
  .byte 116 # StringLit at 10.17
  .byte 32 # StringLit at 10.17
  .byte 103 # StringLit at 10.17
  .byte 101 # StringLit at 10.17
  .byte 116 # StringLit at 10.17
  .byte 32 # StringLit at 10.17
  .byte 104 # StringLit at 10.17
  .byte 101 # StringLit at 10.17
  .byte 114 # StringLit at 10.17
  .byte 101 # StringLit at 10.17
  .byte 46 # StringLit at 10.17
  .byte 10 # StringLit at 10.17
  .byte 0 # StringLit at 10.17
  .byte 0 # StringLit at 10.17
  .word CLASS_String # StringLit at 10.17
  .word 8 # StringLit at 10.17
  .word -26 # StringLit at 10.17
strLit_22: # StringLit at 10.17
.text
.globl main
main:
  jal vm_init
...
mth_main_Main:
 ...
 sw $ra, ($sp)
 lw $s2, 4($sp)
# begin: IntLit at 5.10; stackHeight = 0
  li $t0, 0
 subu $sp, $sp, 8
 sw $t0, ($sp)
# end: IntLit at 5.10; stackHeight = 8
  subu $sp, $sp, 4 # LocalVarDecl at 5.6; stackHeight = 8
  sw $t0, ($sp) # LocalVarDecl at 5.6; stackHeight = 8
# begin: IntLit at 6.10; stackHeight = 12
  li $t0, 24
 subu $sp, $sp, 8
 sw $t0, ($sp)
# end: IntLit at 6.10; stackHeight = 20
  subu $sp, $sp, 4 # LocalVarDecl at 6.6; stackHeight = 20
  sw $t0, ($sp) # LocalVarDecl at 6.6; stackHeight = 20
# begin: CallStmt at 7.8; stackHeight = 24
# begin: Call at 7.8; stackHeight = 24
# begin: Super at 7.8; stackHeight = 24
 subu $sp, $sp, 4
 sw $s2, ($sp)
# end: Super at 7.8; stackHeight = 28
# begin: StringLit at 7.17; stackHeight = 28
 la $t0, strLit_8
 subu $sp, $sp, 4
 sw $t0, ($sp)
# end: StringLit at 7.17; stackHeight = 32
 jal mth_printStr_Lib
# end: Call at 7.8; stackHeight = 32
 lw $t0, ($sp)
 addu $sp, $sp, 4
# end: CallStmt at 7.8; stackHeight = 28
# begin: Divide at 8.11; stackHeight = 28
jal divide
# end: Divide at 8.11; stackHeight = 28
  subu $sp, $sp, 4 # LocalVarDecl at 8.6; stackHeight = 28
  sw $t0, ($sp) # LocalVarDecl at 8.6; stackHeight = 28
# begin: CallStmt at 9.8; stackHeight = 32
# begin: Call at 9.8; stackHeight = 32
# begin: Super at 9.8; stackHeight = 32
 subu $sp, $sp, 4
 sw $s2, ($sp)
# end: Super at 9.8; stackHeight = 36
 jal mth_printInt_Lib
# end: Call at 9.8; stackHeight = 36
 lw $t0, ($sp)
 addu $sp, $sp, 4
# end: CallStmt at 9.8; stackHeight = 32
# begin: CallStmt at 10.8; stackHeight = 32
# begin: Call at 10.8; stackHeight = 32
# begin: Super at 10.8; stackHeight = 32
 subu $sp, $sp, 4
 sw $s2, ($sp)
# end: Super at 10.8; stackHeight = 36
# begin: StringLit at 10.17; stackHeight = 36
 la $t0, strLit_22
 subu $sp, $sp, 4
 sw $t0, ($sp)
# end: StringLit at 10.17; stackHeight = 40
 jal mth_printStr_Lib
# end: Call at 10.8; stackHeight = 40
 lw $t0, ($sp)
 addu $sp, $sp, 4
# end: CallStmt at 10.8; stackHeight = 36
 addu $sp, $sp, 36
 lw $ra, ($sp)
 addu $sp, $sp, 4
 jr $ra
