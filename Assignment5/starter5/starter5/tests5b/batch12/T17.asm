...
END_CLASS_Object: # ClassDecl at 0.0
  .byte 83 # StringLit at 8.16
  .byte 104 # StringLit at 8.16
  .byte 111 # StringLit at 8.16
  .byte 117 # StringLit at 8.16
  .byte 108 # StringLit at 8.16
  .byte 100 # StringLit at 8.16
  .byte 32 # StringLit at 8.16
  .byte 110 # StringLit at 8.16
  .byte 111 # StringLit at 8.16
  .byte 116 # StringLit at 8.16
  .byte 32 # StringLit at 8.16
  .byte 103 # StringLit at 8.16
  .byte 101 # StringLit at 8.16
  .byte 116 # StringLit at 8.16
  .byte 32 # StringLit at 8.16
  .byte 104 # StringLit at 8.16
  .byte 101 # StringLit at 8.16
  .byte 114 # StringLit at 8.16
  .byte 101 # StringLit at 8.16
  .byte 10 # StringLit at 8.16
  .word CLASS_String # StringLit at 8.16
  .word 6 # StringLit at 8.16
  .word -20 # StringLit at 8.16
...
# end: Null at 5.17; stackHeight = 4
  subu $sp, $sp, 4 # LocalVarDecl at 5.10; stackHeight = 4
  sw $t0, ($sp) # LocalVarDecl at 5.10; stackHeight = 4
  subu $sp, $sp, 4 # LocalVarDecl at 6.10; stackHeight = 8
  sw $t0, ($sp) # LocalVarDecl at 6.10; stackHeight = 8
# begin: CallStmt at 8.7; stackHeight = 12
# begin: Call at 8.7; stackHeight = 12
# begin: This at 8.7; stackHeight = 12
 subu $sp, $sp, 4
 sw $s2, ($sp)
# end: This at 8.7; stackHeight = 16
# begin: StringLit at 8.16; stackHeight = 16
 la $t0, strLit_14
 subu $sp, $sp, 4
 sw $t0, ($sp)
# end: StringLit at 8.16; stackHeight = 20
 ...
 lw $s2, ($sp)
 addu $sp, $sp, 4
# end: Call at 8.7; stackHeight = 16
 lw $t0, ($sp)
 addu $sp, $sp, 4
# end: CallStmt at 8.7; stackHeight = 12
 addu $sp, $sp, 12
 lw $ra, ($sp)
 addu $sp, $sp, 4
 jr $ra
