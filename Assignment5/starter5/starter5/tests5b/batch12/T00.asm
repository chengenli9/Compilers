...
END_CLASS_Object: # ClassDecl at 0.0
  .byte 83 # StringLit at 7.17
  .byte 104 # StringLit at 7.17
  .byte 111 # StringLit at 7.17
  .byte 117 # StringLit at 7.17
  .byte 108 # StringLit at 7.17
  .byte 100 # StringLit at 7.17
  .byte 32 # StringLit at 7.17
  .byte 110 # StringLit at 7.17
  .byte 111 # StringLit at 7.17
  ...
  .byte 101 # StringLit at 7.17
  .byte 44 # StringLit at 7.17
  .byte 32 # StringLit at 7.17
  .byte 101 # StringLit at 7.17
  .byte 105 # StringLit at 7.17
  .byte 116 # StringLit at 7.17
  .byte 104 # StringLit at 7.17
  .byte 101 # StringLit at 7.17
  .byte 114 # StringLit at 7.17
  ...
  .word 8 # StringLit at 7.17
  .word -28 # StringLit at 7.17
strLit_7: # StringLit at 7.17
  ...
  .word 6 # StringLit at 10.17
  .word -20 # StringLit at 10.17
strLit_12: # StringLit at 10.17
.text
.globl main
main:
  jal vm_init
...
# end: Null at 5.11; stackHeight = 4
  subu $sp, $sp, 4 # LocalVarDecl at 5.7; stackHeight = 4
  sw $t0, ($sp) # LocalVarDecl at 5.7; stackHeight = 4
# begin: CallStmt at 6.4; stackHeight = 8
# begin: Call at 6.4; stackHeight = 8
 ...
 lw $s2, ($sp)
 addu $sp, $sp, 4
# end: Call at 6.4; stackHeight = 4
 lw $t0, ($sp)
 addu $sp, $sp, 4
# end: CallStmt at 6.4; stackHeight = 0
# begin: CallStmt at 7.8; stackHeight = 0
# begin: Call at 7.8; stackHeight = 0
# begin: Super at 7.8; stackHeight = 0
 subu $sp, $sp, 4
 sw $s2, ($sp)
# end: Super at 7.8; stackHeight = 4
# begin: StringLit at 7.17; stackHeight = 4
 la $t0, strLit_7
 subu $sp, $sp, 4
 sw $t0, ($sp)
# end: StringLit at 7.17; stackHeight = 8
 jal mth_printStr_Lib
# end: Call at 7.8; stackHeight = 8
 lw $t0, ($sp)
 addu $sp, $sp, 4
# end: CallStmt at 7.8; stackHeight = 4
 addu $sp, $sp, 4
 lw $ra, ($sp)
 addu $sp, $sp, 4
 jr $ra
.globl mth_callMe_Main
mth_callMe_Main:
 subu $sp, $sp, 4
 sw $ra, ($sp)
 lw $s2, 4($sp)
# begin: CallStmt at 10.8; stackHeight = 0
# begin: Call at 10.8; stackHeight = 0
# begin: Super at 10.8; stackHeight = 0
 subu $sp, $sp, 4
 sw $s2, ($sp)
# end: Super at 10.8; stackHeight = 4
# begin: StringLit at 10.17; stackHeight = 4
 la $t0, strLit_12
 subu $sp, $sp, 4
 sw $t0, ($sp)
# end: StringLit at 10.17; stackHeight = 8
 jal mth_printStr_Lib
# end: Call at 10.8; stackHeight = 8
 lw $t0, ($sp)
 addu $sp, $sp, 4
# end: CallStmt at 10.8; stackHeight = 4
 addu $sp, $sp, 4
 lw $ra, ($sp)
 addu $sp, $sp, 4
 jr $ra
