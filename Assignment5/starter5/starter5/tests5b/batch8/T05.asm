...
END_CLASS_Object: # ClassDecl at 0.0
  ...
  .word 2 # StringLit at 9.22
  .word -1 # StringLit at 9.22
strLit_27: # StringLit at 9.22
.text
.globl main
main:
  jal vm_init
