...
strLit_12: # StringLit at 7.17
  .byte 83 # StringLit at 9.17
  .byte 104 # StringLit at 9.17
  .byte 111 # StringLit at 9.17
  .byte 117 # StringLit at 9.17
  .byte 108 # StringLit at 9.17
  .byte 100 # StringLit at 9.17
  .byte 32 # StringLit at 9.17
  .byte 110 # StringLit at 9.17
  .byte 111 # StringLit at 9.17
  .byte 116 # StringLit at 9.17
  .byte 32 # StringLit at 9.17
  .byte 103 # StringLit at 9.17
  .byte 101 # StringLit at 9.17
  .byte 116 # StringLit at 9.17
  .byte 32 # StringLit at 9.17
  .byte 104 # StringLit at 9.17
  .byte 101 # StringLit at 9.17
  .byte 114 # StringLit at 9.17
  .byte 101 # StringLit at 9.17
  .byte 46 # StringLit at 9.17
  .byte 10 # StringLit at 9.17
  .byte 0 # StringLit at 9.17
  .byte 0 # StringLit at 9.17
  .byte 0 # StringLit at 9.17
  .word CLASS_String # StringLit at 9.17
  .word 7 # StringLit at 9.17
  .word -21 # StringLit at 9.17
strLit_21: # StringLit at 9.17
.text
.globl main
main:
  jal vm_init
...
# begin: IntLit at 6.6; stackHeight = 12
  li $t0, 8
 subu $sp, $sp, 8
 sw $t0, ($sp)
# end: IntLit at 6.6; stackHeight = 20
# begin: IntLit at 6.11; stackHeight = 20
  li $t0, 24
 subu $sp, $sp, 8
 sw $t0, ($sp)
# end: IntLit at 6.11; stackHeight = 28
# begin: CallStmt at 7.8; stackHeight = 28
# begin: Call at 7.8; stackHeight = 28
# begin: Super at 7.8; stackHeight = 28
 subu $sp, $sp, 4
 sw $s2, ($sp)
# end: Super at 7.8; stackHeight = 32
# begin: StringLit at 7.17; stackHeight = 32
 la $t0, strLit_12
 subu $sp, $sp, 4
 sw $t0, ($sp)
# end: StringLit at 7.17; stackHeight = 36
 jal mth_printStr_Lib
# end: Call at 7.8; stackHeight = 36
 lw $t0, ($sp)
 addu $sp, $sp, 4
# end: CallStmt at 7.8; stackHeight = 32
# begin: IntLit at 8.6; stackHeight = 32
  li $t0, 9
 subu $sp, $sp, 8
 sw $t0, ($sp)
# end: IntLit at 8.6; stackHeight = 40
# begin: IntLit at 8.11; stackHeight = 40
  li $t0, 22
 subu $sp, $sp, 8
 sw $t0, ($sp)
# end: IntLit at 8.11; stackHeight = 48
# begin: CallStmt at 9.8; stackHeight = 48
# begin: Call at 9.8; stackHeight = 48
# begin: Super at 9.8; stackHeight = 48
 subu $sp, $sp, 4
 sw $s2, ($sp)
# end: Super at 9.8; stackHeight = 52
# begin: StringLit at 9.17; stackHeight = 52
 la $t0, strLit_21
 subu $sp, $sp, 4
 sw $t0, ($sp)
# end: StringLit at 9.17; stackHeight = 56
 jal mth_printStr_Lib
# end: Call at 9.8; stackHeight = 56
 lw $t0, ($sp)
 addu $sp, $sp, 4
# end: CallStmt at 9.8; stackHeight = 52
 addu $sp, $sp, 52
 lw $ra, ($sp)
 addu $sp, $sp, 4
 jr $ra
